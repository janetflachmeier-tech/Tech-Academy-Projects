...
function Handle_Operator(Next_Operator) {
  const { First_Operand, Display_Value, operator } = Calculator;
    ...
    //display value to a number and then store the result in
...
function Update_Screen() {
  //Make sure of the calculator-screen class to target the input tag in the HTML document       
  const screen = document.querySelector('.calculator-screen');
  screen.value = Calculator.Display_Value;
}
