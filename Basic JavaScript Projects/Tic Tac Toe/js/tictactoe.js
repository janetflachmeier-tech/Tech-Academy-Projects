...
//This variable keeps track of the body element to disable/enable clicking.
...
//This function checks to see if any win conditions are met.
function checkWinConditions() {
    ...
    //X 2, 4, 6 condition.
    else if (arrayIncludes('2X', '4X', '6X')) { drawWinLine(508, 100, 90, 520) }
    //O 0, 1, 2 condition.
    ...
    //O 2, 4, 6 condition.
    else if (arrayIncludes('2O', '4O', '6O')) { drawWinLine(508, 100, 90, 520) }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function clear() {
        ...
        c.clearRect(0, 0, 608, 608);
        //This method stops our animation loop.
